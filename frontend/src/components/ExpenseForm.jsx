...
const ExpenseForm = ({ fetchExpenses, expenseToEdit, onClose }) => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(apiMessage || "Failed to save expense");
    } finally {
      ...
      <div className="relative w-full max-w-lg mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-6 relative z-10 w-full flex-col items-center">
          ...
          <p className="text-slate-500 mt-1 text-sm font-medium tracking-wide">
            Categorize your spending to keep your budget healthy.
          </p>
        </div>
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-primary-600 font-medium text-xl">
                  ₹
                </span>
                <input
                  type="number"
        ...
        <div className="mt-6 bg-success-50 border border-success-100 rounded-xl p-4 flex gap-3 text-left w-full relative z-10 shadow-sm">
          <div className="text-success-600 mt-0.5">
            <FiActivity size={18} />
          </div>
          <div>
            <h4 className="font-bold text-success-800 text-sm tracking-tight mb-1">
              Financial Intelligence Tip
            </h4>
            <p className="text-xs text-success-700/80 leading-relaxed font-medium">
              Categorizing this expense helps BudgetBuddy predict your
              end-of-semester savings more accurately.
            </p>
          </div>
        </div>
      </div>
